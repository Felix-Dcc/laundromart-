...
try {
    // Get request details
    $stmt = $pdo->prepare("
        SELECT lr.*, lp.price_per_kg, lp.description as service_description
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <div class="d-grid gap-2">
                    ...
                    <a href="new-request.php" class="btn btn-outline-success">
                        <i class="bi bi-plus-circle me-2"></i>New Request
                    </a>
                    <?php if ($request['status'] === 'delivered'): ?>
                        <button type="button" class="btn btn-outline-warning" onclick="showFeedbackModal()">
